...
export class FeathersClientService {
  ...
  constructor(private ability: PureAbility, private router: Router) {
  ...
  public async start() {
    ...
    await this._feathers
      .reAuthenticate()
      .then(() => console.log('Initial authentication with stored JWT done!'))
      .catch(() => console.log('No valid token for inicial re-authentication'));
  }
