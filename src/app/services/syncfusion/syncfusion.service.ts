...
import { L10n, loadCldr, setCulture, registerLicense } from '@syncfusion/ej2-base';
import { lastValueFrom } from 'rxjs';

// This part is executed despite the fact that the service is not used
registerLicense(
  'ORg4AjUWIQA/Gnt2U1hhQlJBfV5AQmBIYVp/TGpJfl96cVxMZVVBJAtUQF1hTX5VdUVjUX1ccXNVQmdV'
);
